...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 457.5, 41.0, 150.0, 47.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 181.0, 193.0, 43.0, 22.0 ],
									"text" : "* 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 289.0, 350.0, 61.0, 22.0 ],
									"text" : "out 4 led2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 225.5, 350.0, 61.0, 22.0 ],
									"text" : "out 3 led1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.5, 96.0, 127.0, 22.0 ],
									"text" : "param knob1 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 158.5, 448.0, 35.0, 22.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 117.5, 448.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					...
					"saved_object_attributes" : 					{
						"exportfolder" : "airplane2:/Users/danielfishkin/gitprojects/learning_daisy/",
						"exportname" : "oopsy_karplus"
					}
,
					"text" : "gen~",
					"varname" : "oopsy_karplus"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 429.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 18.0, 323.0, 44.0, 90.0 ],
